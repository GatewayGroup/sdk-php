...
class gggpayCfg
{
     ...
     */
    public static $CLIENT_ID = "10020";

    /**
     * in developer settings : Key
     */
    public static $CLIENT_SYMMETRIC_KEY = "PCd1dlEmFnBXaVce06Pzp7Vike0oHnVJ";

    /**
     * in developer settings : Secret
     */
    public static $CLIENT_SECRET = "F0NfID1ftdGdu27ybGMfT3vqqCMM9gwO";

    /**
     * in developer settings : Server Public Key
     */
    public static $SERVER_PUB_KEY = "-----BEGIN PUBLIC KEY-----\n" .
     ...
     * @param $privateKey privateKey privateKey in developer settings : Private Key
     * @return void
     */
    public static function init($verNo, $apiUrl, $appId, $key, $secret, $serverPubKey, $privateKey)
    {
        self::$VERSION_NO = $verNo;
        self::$BASE_URL = $apiUrl;
        self::$CLIENT_ID = $appId;
        self::$CLIENT_SYMMETRIC_KEY = $key;
        self::$CLIENT_SECRET = $secret;
        self::$SERVER_PUB_KEY = $serverPubKey;
